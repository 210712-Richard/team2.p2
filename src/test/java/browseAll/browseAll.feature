...
Given url 'https//localhost:8080/users/Khine/item'
When method get
Then status 200
And print 'Response is: ', response
And match response contains{"id":"0000","name":"cucumber","storeName":"cucumberfarm","price":"3.50","category":"toys","picture":""}
